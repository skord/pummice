...
if BuildingCard.count == 0
  ...
  BuildingCard.create(name: "Clay Mound", variant: GameVariant::ALL, key: "H01", is_base: true, is_cloister: false, 
    ...
    number_players: NumberOfPlayers::ONE | NumberOfPlayers::TWO | NumberOfPlayers::THREE | NumberOfPlayers::FOUR | 
      NumberOfPlayers::TWO_LONG | NumberOfPlayers::THREE_SHORT | NumberOfPlayers::FOUR_SHORT, 
  ...
  # Settlements
  BuildingCard.create(name: "Shanty Town", variant: GameVariant::ALL, key: "S01", is_base: true, is_cloister: false, 
  ...
  BuildingCard.create(name: "Farming Village", variant: GameVariant::ALL, key: "S02", is_base: true, is_cloister: false, 
    age: Age::START, available_location_types: LocationType::COAST | LocationType::PLAINS | LocationType::HILLSIDE, 
    number_players: NumberOfPlayers::ONE | NumberOfPlayers::TWO | NumberOfPlayers::THREE | NumberOfPlayers::FOUR | 
      NumberOfPlayers::TWO_LONG | NumberOfPlayers::THREE_SHORT | NumberOfPlayers::FOUR_SHORT, 
  ...
  BuildingCard.create(name: "Market Town", variant: GameVariant::ALL, key: "S03", is_base: true, is_cloister: false, 
    age: Age::START, available_location_types: LocationType::COAST | LocationType::PLAINS | LocationType::HILLSIDE, 
    number_players: NumberOfPlayers::ONE | NumberOfPlayers::TWO | NumberOfPlayers::THREE | NumberOfPlayers::FOUR | 
      NumberOfPlayers::TWO_LONG | NumberOfPlayers::THREE_SHORT | NumberOfPlayers::FOUR_SHORT, 
  ...
  BuildingCard.create(name: "Fishing Village", variant: GameVariant::ALL, key: "S04", is_base: true, is_cloister: false, 
  ...
  BuildingCard.create(name: "Artist's Colony", variant: GameVariant::ALL, key: "S05", is_base: true, is_cloister: false, 
  ...
  BuildingCard.create(name: "Hamlet", variant: GameVariant::ALL, key: "S06", is_base: true, is_cloister: false, 
  ...
  BuildingCard.create(name: "Village", variant: GameVariant::ALL, key: "S07", is_base: true, is_cloister: false, 
  ...
  BuildingCard.create(name: "Hilltop Village", variant: GameVariant::ALL, key: "S08", is_base: true, is_cloister: false, 
  ...
  BuildingCard.create(name: "Priory", variant: GameVariant::ALL, key: "G01", is_base: false, is_cloister: true, 
    age: Age::START, available_location_types: LocationType::COAST | LocationType::PLAINS | LocationType::HILLSIDE, 
    number_players: NumberOfPlayers::ONE | NumberOfPlayers::THREE | NumberOfPlayers::FOUR | 
      NumberOfPlayers::TWO_LONG | NumberOfPlayers::FOUR_SHORT, 
  ...
  BuildingCard.create(name: "Grain Storage", variant: GameVariant::FRANCE, key: "F03", is_base: false, is_cloister: false, 
    age: Age::START, available_location_types: LocationType::COAST | LocationType::PLAINS | LocationType::HILLSIDE, 
    number_players: NumberOfPlayers::ONE | NumberOfPlayers::FOUR | NumberOfPlayers::TWO_LONG, 
  ...
  BuildingCard.create(name: "Builders' Market", variant: GameVariant::ALL, key: "G13", is_base: false, is_cloister: false, 
    age: Age::START, available_location_types: LocationType::COAST | LocationType::PLAINS | LocationType::HILLSIDE, 
    number_players: NumberOfPlayers::FOUR | NumberOfPlayers::TWO_LONG, 
    cost_wood: 0, cost_clay: 2, cost_stone: 0, cost_straw: 0, cost_coin: 0, cost_fuel: 0, cost_food: 0, 
    economic_value: 6, dwelling_value: 1)
  ...
  BuildingCard.create(name: "Grapevine", variant: GameVariant::FRANCE, key: "F14", is_base: false, is_cloister: false, 
    ...
    number_players: NumberOfPlayers::TWO | NumberOfPlayers::THREE | NumberOfPlayers::FOUR | 
      NumberOfPlayers::TWO_LONG | NumberOfPlayers::THREE_SHORT | NumberOfPlayers::FOUR_SHORT, 
    cost_wood: 1, cost_clay: 0, cost_stone: 0, cost_straw: 0, cost_coin: 0, cost_fuel: 0, cost_food: 0, 
  ...
  BuildingCard.create(name: "Quarry", variant: GameVariant::FRANCE, key: "F29", is_base: false, is_cloister: false, 
    ...
    number_players: NumberOfPlayers::THREE | NumberOfPlayers::FOUR | NumberOfPlayers::FOUR_SHORT, 
    cost_wood: 0, cost_clay: 0, cost_stone: 0, cost_straw: 0, cost_coin: 5, cost_fuel: 0, cost_food: 0, 
    economic_value: 7, dwelling_value: -4)
